...
@Component
public class TagNotificationProcessor implements NotificationProcessor {
    ...
    public void process(Notification notification) throws IOException {
        ...
        // save to database
        notificationRepository.save(actionNotification);
        ...
        System.out.println("/topic/like-notification/" + actionNotification.getReceivedid());

        this.messagingTemplate.convertAndSend("/topic/like-notification/" + actionNotification.getReceivedid(), datas);
    }
}
