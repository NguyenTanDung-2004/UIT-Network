...
export default function SuggestionFriendPage() {
  ...
  const handleAddFriend = (userId: string) => {
    console.log("Add friend suggestion:", userId);
              ...
              actions={
                <>
                  ...
                  <button
                    onClick={(e) => {
                      e.stopPropagation();
                      handleRemoveSuggestion(user.id);
                    }}
      ...
      >
        {selectedUserId ? (
          ...
          <div className="text-center text-gray-500 dark:text-gray-400 flex flex-col items-center justify-center h-full">
            ...
            />
            <p>Select a person to preview their profile</p>
          </div>
        )}
      </div>
    </div>
