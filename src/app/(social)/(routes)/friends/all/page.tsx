...
export default function AllFriendPage() {
  ...
  const handleChat = (userId: string) => {
    console.log("Start chat with friend:", userId);
    // Add logic to navigate to chat page or open chat window
  };

  const handleUnfriend = (userId: string) => {
    console.log("Unfriend user:", userId);
    // Add logic to remove friend
  ...
  return (
    <div className="flex flex-col md:flex-row h-full pb-4 md:pb-0 overflow-hidden">
      <div className="w-full mb-2 md:w-80 flex-shrink-0 border-r-0 md:border-r border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 flex flex-col h-full overflow-hidden">
        ...
        <div className="flex-shrink-0 px-4 pb-3 pt-2 border-b border-gray-200 dark:border-gray-700">
          <div className="relative">
            <input
              ...
              className="w-full pl-10 pr-4 py-2 rounded-full bg-gray-100 dark:bg-gray-700 border border-transparent focus:border-primary focus:bg-white dark:focus:bg-gray-800 focus:outline-none focus:ring-0 text-sm text-gray-900 dark:text-gray-200 placeholder-gray-500 dark:placeholder-gray-400"
            />
      ...
      >
        {selectedUserId ? (
          ...
          <div className="text-center text-gray-500 dark:text-gray-400 flex flex-col items-center justify-center h-full">
            ...
            />
            <p>Select a friend to preview their profile</p>
          </div>
        )}
      </div>
    </div>
